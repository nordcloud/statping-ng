            ...
            <div class="col-md-3 col-sm-12 mb-4 mb-md-0">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <div v-if="version_below" class="col-12 small text-center mt-0 pt-0 pb-0 mb-3">
                      ...
                      <div class="row">
                        <div class="col-6">
                          <a href="https://github.com/nordcloud/statping-ng/releases/latest" class="btn btn-sm text-success mt-2">Download</a>
                        </div>
                        <div class="col-6">
                          <a href="https://github.com/nordcloud/statping-ng/blob/master/CHANGELOG.md" class="btn btn-sm text-dim mt-2">Changelog</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <a @click.prevent="changeTab" class="nav-link" v-bind:class="{active: liClass('v-pills-configs-tab')}" id="v-pills-configs-tab" data-toggle="pill" href="#v-pills-configs" role="tab" aria-controls="v-pills-configs" aria-selected="false">
                    ...
                    <a href="https://github.com/nordcloud/statping-ng/wiki" class="mb-2 font-2 text-decoration-none text-muted">
                        <font-awesome-icon icon="question" class="mr-3"/> {{$t('docs')}}
                    </a>

                    <a href="https://github.com/nordcloud/statping-ng/wiki/API" class="mb-2 font-2 text-decoration-none text-muted">
                    ...
                    <a href="https://github.com/nordcloud/statping-ng" class="mb-2 font-2 text-decoration-none text-muted">
                  ...
                  <span class="small text-dim text-center mt-5">Statping-ng v{{core.version}}<br>
                    <a class="small text-muted no-decoration" v-if="core.commit" v-bind:href="`https://github.com/nordcloud/statping-ng/commit/${core.commit}`">{{core.commit.slice(0,8)}}</a>
                  </span>
